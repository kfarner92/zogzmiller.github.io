...
for (var i = 0; i < allDogs.length; i++) {
 if (i == i)
   ...
   .bindPopup("<h2>" + allDogs[i].dog_id + "<h2><br><h3>" + "<br> Breed: " + allDogs[i].age + "<br> Age: " + allDogs[i].breed + "<br>" + "<a href = " + allDogs[i].website + " target= `_blank`>" + ` Learn more about ${allDogs[i].dog_id} </a>` + "<h3>")
 ));
}
...
for (var i = 0; i < allCats.length; i++) {
  if (i == i)
    ...
    .bindPopup("<h2>" + allCats[i].cat_id + "<h2><br><h3>" + "<br> Breed: " + allCats[i].age + "<br> Age: " + allCats[i].breed + "<br>" + "<a href = " + allCats[i].website + " target= `_blank`>" + ` Learn more about ${allCats[i].cat_id} </a>` + "<h3>")
  ));
 }
